# Seven Quests - Deep Research Analysis

**Priority:** 70 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/70_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `70_*_research_prompt.md` (starts with 70)
...
| Aspect | Seven Quests | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
