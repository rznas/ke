# Prince of Persia (2008 Reboot) - Deep Research Analysis

**Priority:** 61 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/61_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `61_*_research_prompt.md` (starts with 61)
...
| Aspect | Prince of Persia (2008 Reboot) | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
