# Immortals Fenyx Rising - Deep Research Analysis

**Priority:** 49 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/49_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `49_*_research_prompt.md` (starts with 49)
...
| Aspect | Immortals Fenyx Rising | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
