# Hitman (2016) - Deep Research Analysis

**Priority:** 16 (TIER_2)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/16_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `16_*_research_prompt.md` (starts with 16)
...
| Aspect | Hitman (2016) | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
