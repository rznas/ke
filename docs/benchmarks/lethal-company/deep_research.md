# Lethal Company - Deep Research Analysis

**Priority:** 54 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/54_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `54_*_research_prompt.md` (starts with 54)
...
| Aspect | Lethal Company | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
