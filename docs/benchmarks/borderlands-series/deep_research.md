# Borderlands series - Deep Research Analysis

**Priority:** 38 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/38_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `38_*_research_prompt.md` (starts with 38)
...
| Aspect | Borderlands series | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
