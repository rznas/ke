# Raji - Deep Research Analysis

**Priority:** 65 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/65_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `65_*_research_prompt.md` (starts with 65)
