# Life is Strange: True Colors - Deep Research Analysis

**Priority:** 56 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/56_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `56_*_research_prompt.md` (starts with 56)
...
| Aspect | Life is Strange: True Colors | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
