# Prince of Persia: The Sands of Time - Deep Research Analysis

**Priority:** 05 (TIER_1)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/05_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `05_*_research_prompt.md` (starts with 05)
...
| Aspect | Prince of Persia: The Sands of Time | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
