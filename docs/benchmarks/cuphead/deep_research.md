# Cuphead - Deep Research Analysis

**Priority:** 41 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/41_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `41_*_research_prompt.md` (starts with 41)
