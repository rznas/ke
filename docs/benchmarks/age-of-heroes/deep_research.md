# Age of Heroes - Deep Research Analysis

**Priority:** 30 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/30_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `30_*_research_prompt.md` (starts with 30)
...
| Aspect | Age of Heroes | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
