# Blasphemous - Deep Research Analysis

**Priority:** 37 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/37_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `37_*_research_prompt.md` (starts with 37)
...
| Aspect | Blasphemous | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
