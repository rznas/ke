# Okami - Deep Research Analysis

**Priority:** 19 (TIER_2)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/19_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `19_*_research_prompt.md` (starts with 19)
