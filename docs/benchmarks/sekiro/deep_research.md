# Sekiro - Deep Research Analysis

**Priority:** 69 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/69_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `69_*_research_prompt.md` (starts with 69)
