# Sekiro: Shadows Die Twice - Deep Research Analysis

**Priority:** 06 (TIER_1)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/06_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `06_*_research_prompt.md` (starts with 06)
...
| Aspect | Sekiro: Shadows Die Twice | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
