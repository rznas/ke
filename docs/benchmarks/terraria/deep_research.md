# Terraria - Deep Research Analysis

**Priority:** 75 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/75_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `75_*_research_prompt.md` (starts with 75)
