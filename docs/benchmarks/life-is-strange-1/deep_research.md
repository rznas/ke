# Life is Strange 1 - Deep Research Analysis

**Priority:** 55 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/55_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `55_*_research_prompt.md` (starts with 55)
...
| Aspect | Life is Strange 1 | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
