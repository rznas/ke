# Shovel Knight - Deep Research Analysis

**Priority:** 71 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/71_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `71_*_research_prompt.md` (starts with 71)
...
| Aspect | Shovel Knight | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
