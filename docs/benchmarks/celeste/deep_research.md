# Celeste - Deep Research Analysis

**Priority:** 12 (TIER_2)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/12_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `12_*_research_prompt.md` (starts with 12)
