# Papers, Please - Deep Research Analysis

**Priority:** 59 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/59_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `59_*_research_prompt.md` (starts with 59)
...
| Aspect | Papers, Please | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
