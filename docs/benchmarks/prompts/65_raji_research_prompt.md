...
Your task is to research <game_name>Raji</game_name> and create a focused benchmark analysis tailored to Shahnameh development.

IMPORTANCE LEVEL: REFERENCE (TIER_3)
DEVELOPER: Cultural representation pitfalls
</research_context>
...
Research <game_name>Raji</game_name> comprehensively using web searches, YouTube, reviews, developer interviews, GDC talks, Reddit discussions, and other credible sources.
...
<special_focus_areas>
If Raji matches any of these, give EXTRA attention:
...
**GAME TO RESEARCH:** <game_name>Raji</game_name>
**DEVELOPER:** Cultural representation pitfalls
