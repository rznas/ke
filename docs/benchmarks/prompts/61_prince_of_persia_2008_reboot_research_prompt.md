...
Your task is to research <game_name>Prince of Persia (2008 Reboot)</game_name> and create a focused benchmark analysis tailored to Shahnameh development.

IMPORTANCE LEVEL: REFERENCE (TIER_3)
DEVELOPER: Heavily based on Zoroastrianism; Ormazd vs. Ahriman; art direction nominated for awards despite criticism of "Anglicized" protagonist
</research_context>
...
Research <game_name>Prince of Persia (2008 Reboot)</game_name> comprehensively using web searches, YouTube, reviews, developer interviews, GDC talks, Reddit discussions, and other credible sources.
...
<special_focus_areas>
If Prince of Persia (2008 Reboot) matches any of these, give EXTRA attention:
...
**GAME TO RESEARCH:** <game_name>Prince of Persia (2008 Reboot)</game_name>
**DEVELOPER:** Heavily based on Zoroastrianism; Ormazd vs. Ahriman; art direction nominated for awards despite criticism of "Anglicized" protagonist
**RELEVANCE TIER:** TIER_3
