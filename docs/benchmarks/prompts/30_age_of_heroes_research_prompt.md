...
Your task is to research <game_name>Age of Heroes</game_name> and create a focused benchmark analysis tailored to Shahnameh development.

IMPORTANCE LEVEL: REFERENCE (TIER_3)
DEVELOPER: 90+ Shahnameh figures; commissioned by Ferdowsi Foundation
</research_context>
...
Research <game_name>Age of Heroes</game_name> comprehensively using web searches, YouTube, reviews, developer interviews, GDC talks, Reddit discussions, and other credible sources.
...
<special_focus_areas>
If Age of Heroes matches any of these, give EXTRA attention:
...
**GAME TO RESEARCH:** <game_name>Age of Heroes</game_name>
**DEVELOPER:** 90+ Shahnameh figures; commissioned by Ferdowsi Foundation
