...
Your task is to research <game_name>Vampire Survivors</game_name> and create a focused benchmark analysis tailored to Shahnameh development.

IMPORTANCE LEVEL: REFERENCE (TIER_3)
DEVELOPER: Luca Galante (1 person); Phaser JS (FREE); ~£40M net worth now
</research_context>
...
Research <game_name>Vampire Survivors</game_name> comprehensively using web searches, YouTube, reviews, developer interviews, GDC talks, Reddit discussions, and other credible sources.
...
<special_focus_areas>
If Vampire Survivors matches any of these, give EXTRA attention:
...
**GAME TO RESEARCH:** <game_name>Vampire Survivors</game_name>
**DEVELOPER:** Luca Galante (1 person); Phaser JS (FREE); ~£40M net worth now
