...
Your task is to research <game_name>Sifu</game_name> and create a focused benchmark analysis tailored to Shahnameh development.

IMPORTANCE LEVEL: IMMEDIATE (TIER_1)
DEVELOPER: Sloclap (~50 people)
</research_context>
...
Research <game_name>Sifu</game_name> comprehensively using web searches, YouTube, reviews, developer interviews, GDC talks, Reddit discussions, and other credible sources.
...
<special_focus_areas>
If Sifu matches any of these, give EXTRA attention:
...
**GAME TO RESEARCH:** <game_name>Sifu</game_name>
**DEVELOPER:** Sloclap (~50 people)
