...
Your task is to research <game_name>Ghost of Tsushima</game_name> and create a focused benchmark analysis tailored to Shahnameh development.

IMPORTANCE LEVEL: REFERENCE (TIER_3)
DEVELOPER: Detailed GDC combat talks
</research_context>
...
Research <game_name>Ghost of Tsushima</game_name> comprehensively using web searches, YouTube, reviews, developer interviews, GDC talks, Reddit discussions, and other credible sources.
...
<special_focus_areas>
If Ghost of Tsushima matches any of these, give EXTRA attention:
...
**GAME TO RESEARCH:** <game_name>Ghost of Tsushima</game_name>
**DEVELOPER:** Detailed GDC combat talks
