...
Your task is to research <game_name>Dark Souls</game_name> and create a focused benchmark analysis tailored to Shahnameh development.

IMPORTANCE LEVEL: IMMEDIATE (TIER_1)
DEVELOPER: FromSoftware (~195 people credits, DS1)
</research_context>
...
Research <game_name>Dark Souls</game_name> comprehensively using web searches, YouTube, reviews, developer interviews, GDC talks, Reddit discussions, and other credible sources.
...
<special_focus_areas>
If Dark Souls matches any of these, give EXTRA attention:
...
**GAME TO RESEARCH:** <game_name>Dark Souls</game_name>
**DEVELOPER:** FromSoftware (~195 people credits, DS1)
