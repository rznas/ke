...
Your task is to research <game_name>Blasphemous</game_name> and create a focused benchmark analysis tailored to Shahnameh development.

IMPORTANCE LEVEL: REFERENCE (TIER_3)
DEVELOPER: The Game Kitchen (~5 initial, grew post-Kickstarter); Spanish Catholic imagery approach
</research_context>
...
Research <game_name>Blasphemous</game_name> comprehensively using web searches, YouTube, reviews, developer interviews, GDC talks, Reddit discussions, and other credible sources.
...
<special_focus_areas>
If Blasphemous matches any of these, give EXTRA attention:
...
**GAME TO RESEARCH:** <game_name>Blasphemous</game_name>
**DEVELOPER:** The Game Kitchen (~5 initial, grew post-Kickstarter); Spanish Catholic imagery approach
