...
Your task is to research <game_name>Quest of Persia series</game_name> and create a focused benchmark analysis tailored to Shahnameh development.

IMPORTANCE LEVEL: REFERENCE (TIER_3)
DEVELOPER: Puya Arts; claims "100% Persian" vs Prince of Persia's Arab/Indian elements
</research_context>
...
Research <game_name>Quest of Persia series</game_name> comprehensively using web searches, YouTube, reviews, developer interviews, GDC talks, Reddit discussions, and other credible sources.
...
<special_focus_areas>
If Quest of Persia series matches any of these, give EXTRA attention:
...
**GAME TO RESEARCH:** <game_name>Quest of Persia series</game_name>
**DEVELOPER:** Puya Arts; claims "100% Persian" vs Prince of Persia's Arab/Indian elements
