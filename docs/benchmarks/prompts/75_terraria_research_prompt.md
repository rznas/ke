...
Your task is to research <game_name>Terraria</game_name> and create a focused benchmark analysis tailored to Shahnameh development.

IMPORTANCE LEVEL: REFERENCE (TIER_3)
DEVELOPER: Re-Logic (started solo, now ~11); 58M+ copies; 4 months initial dev
</research_context>
...
Research <game_name>Terraria</game_name> comprehensively using web searches, YouTube, reviews, developer interviews, GDC talks, Reddit discussions, and other credible sources.
...
<special_focus_areas>
If Terraria matches any of these, give EXTRA attention:
...
**GAME TO RESEARCH:** <game_name>Terraria</game_name>
**DEVELOPER:** Re-Logic (started solo, now ~11); 58M+ copies; 4 months initial dev
