# Undertale - Deep Research Analysis

**Priority:** 09 (TIER_1)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/09_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `09_*_research_prompt.md` (starts with 09)
...
| Aspect | Undertale | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
