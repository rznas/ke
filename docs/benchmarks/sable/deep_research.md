# Sable - Deep Research Analysis

**Priority:** 67 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/67_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `67_*_research_prompt.md` (starts with 67)
