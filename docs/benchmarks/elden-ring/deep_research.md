# Elden Ring - Deep Research Analysis

**Priority:** 14 (TIER_2)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/14_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `14_*_research_prompt.md` (starts with 14)
...
| Aspect | Elden Ring | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
