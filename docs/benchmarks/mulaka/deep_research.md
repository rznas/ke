# Mulaka - Deep Research Analysis

**Priority:** 18 (TIER_2)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/18_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `18_*_research_prompt.md` (starts with 18)
