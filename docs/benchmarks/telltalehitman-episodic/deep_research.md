# Telltale/Hitman episodic - Deep Research Analysis

**Priority:** 74 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/74_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `74_*_research_prompt.md` (starts with 74)
...
| Aspect | Telltale/Hitman episodic | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
