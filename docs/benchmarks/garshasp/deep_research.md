# Garshasp - Deep Research Analysis

**Priority:** 44 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/44_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `44_*_research_prompt.md` (starts with 44)
