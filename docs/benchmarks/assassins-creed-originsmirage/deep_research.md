# Assassin's Creed Origins/Mirage - Deep Research Analysis

**Priority:** 32 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/32_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `32_*_research_prompt.md` (starts with 32)
...
| Aspect | Assassin's Creed Origins/Mirage | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
