# Balatro - Deep Research Analysis

**Priority:** 02 (TIER_1)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/02_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `02_*_research_prompt.md` (starts with 02)
