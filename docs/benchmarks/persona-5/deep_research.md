# Persona 5 - Deep Research Analysis

**Priority:** 60 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/60_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `60_*_research_prompt.md` (starts with 60)
...
| Aspect | Persona 5 | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
