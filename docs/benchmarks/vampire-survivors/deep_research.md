# Vampire Survivors - Deep Research Analysis

**Priority:** 78 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/78_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `78_*_research_prompt.md` (starts with 78)
...
| Aspect | Vampire Survivors | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
