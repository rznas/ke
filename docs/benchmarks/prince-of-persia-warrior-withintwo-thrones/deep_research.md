# Prince of Persia: Warrior Within/Two Thrones - Deep Research Analysis

**Priority:** 63 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/63_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `63_*_research_prompt.md` (starts with 63)
...
| Aspect | Prince of Persia: Warrior Within/Two Thrones | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
