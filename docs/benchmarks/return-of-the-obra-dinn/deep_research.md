# Return of the Obra Dinn - Deep Research Analysis

**Priority:** 22 (TIER_2)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/22_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `22_*_research_prompt.md` (starts with 22)
...
| Aspect | Return of the Obra Dinn | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
