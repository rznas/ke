# Sifu - Deep Research Analysis

**Priority:** 07 (TIER_1)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/07_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `07_*_research_prompt.md` (starts with 07)
