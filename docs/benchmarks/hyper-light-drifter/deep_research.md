# Hyper Light Drifter - Deep Research Analysis

**Priority:** 17 (TIER_2)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/17_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `17_*_research_prompt.md` (starts with 17)
...
| Aspect | Hyper Light Drifter | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
