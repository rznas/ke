# Salt and Sanctuary - Deep Research Analysis

**Priority:** 68 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/68_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `68_*_research_prompt.md` (starts with 68)
...
| Aspect | Salt and Sanctuary | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
