# Tales from the Borderlands - Deep Research Analysis

**Priority:** 73 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/73_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `73_*_research_prompt.md` (starts with 73)
...
| Aspect | Tales from the Borderlands | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
