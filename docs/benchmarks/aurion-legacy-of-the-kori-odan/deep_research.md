# Aurion: Legacy of the Kori-Odan - Deep Research Analysis

**Priority:** 34 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/34_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `34_*_research_prompt.md` (starts with 34)
...
| Aspect | Aurion: Legacy of the Kori-Odan | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
