# Gris - Deep Research Analysis

**Priority:** 46 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/46_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `46_*_research_prompt.md` (starts with 46)
