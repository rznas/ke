# Tunic - Deep Research Analysis

**Priority:** 23 (TIER_2)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/23_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `23_*_research_prompt.md` (starts with 23)
