# Cave Story - Deep Research Analysis

**Priority:** 39 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/39_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `39_*_research_prompt.md` (starts with 39)
...
| Aspect | Cave Story | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
