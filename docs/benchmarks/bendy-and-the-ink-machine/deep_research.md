# Bendy and the Ink Machine - Deep Research Analysis

**Priority:** 11 (TIER_2)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/11_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `11_*_research_prompt.md` (starts with 11)
...
| Aspect | Bendy and the Ink Machine | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
