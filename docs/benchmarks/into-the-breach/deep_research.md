# Into the Breach - Deep Research Analysis

**Priority:** 50 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/50_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `50_*_research_prompt.md` (starts with 50)
...
| Aspect | Into the Breach | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
