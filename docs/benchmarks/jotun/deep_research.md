# Jotun - Deep Research Analysis

**Priority:** 51 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/51_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `51_*_research_prompt.md` (starts with 51)
