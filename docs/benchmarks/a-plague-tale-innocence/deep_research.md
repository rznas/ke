# A Plague Tale: Innocence - Deep Research Analysis

**Priority:** 10 (TIER_2)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/10_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `10_*_research_prompt.md` (starts with 10)
...
| Aspect | A Plague Tale: Innocence | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
