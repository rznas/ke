# Resident Evil Revelations 2 - Deep Research Analysis

**Priority:** 66 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/66_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `66_*_research_prompt.md` (starts with 66)
...
| Aspect | Resident Evil Revelations 2 | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
