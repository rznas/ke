# Disco Elysium - Deep Research Analysis

**Priority:** 42 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/42_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `42_*_research_prompt.md` (starts with 42)
...
| Aspect | Disco Elysium | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
