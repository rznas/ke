# Asura's Wrath - Deep Research Analysis

**Priority:** 33 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/33_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `33_*_research_prompt.md` (starts with 33)
...
| Aspect | Asura's Wrath | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
