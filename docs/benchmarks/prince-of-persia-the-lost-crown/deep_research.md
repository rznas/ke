# Prince of Persia: The Lost Crown - Deep Research Analysis

**Priority:** 62 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/62_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `62_*_research_prompt.md` (starts with 62)
...
| Aspect | Prince of Persia: The Lost Crown | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
