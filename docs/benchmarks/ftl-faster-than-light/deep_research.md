# FTL: Faster Than Light - Deep Research Analysis

**Priority:** 43 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/43_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `43_*_research_prompt.md` (starts with 43)
...
| Aspect | FTL: Faster Than Light | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
