# Ori and the Blind Forest - Deep Research Analysis

**Priority:** 20 (TIER_2)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/20_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `20_*_research_prompt.md` (starts with 20)
...
| Aspect | Ori and the Blind Forest | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
