# Apotheon - Deep Research Analysis

**Priority:** 31 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/31_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `31_*_research_prompt.md` (starts with 31)
