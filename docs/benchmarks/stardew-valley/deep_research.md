# Stardew Valley - Deep Research Analysis

**Priority:** 08 (TIER_1)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/08_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `08_*_research_prompt.md` (starts with 08)
...
| Aspect | Stardew Valley | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
