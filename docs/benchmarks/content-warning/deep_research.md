# Content Warning - Deep Research Analysis

**Priority:** 40 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/40_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `40_*_research_prompt.md` (starts with 40)
...
| Aspect | Content Warning | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
