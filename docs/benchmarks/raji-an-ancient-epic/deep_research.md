# Raji: An Ancient Epic - Deep Research Analysis

**Priority:** 21 (TIER_2)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/21_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `21_*_research_prompt.md` (starts with 21)
...
| Aspect | Raji: An Ancient Epic | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
