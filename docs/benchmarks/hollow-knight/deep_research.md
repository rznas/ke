# Hollow Knight - Deep Research Analysis

**Priority:** 48 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/48_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `48_*_research_prompt.md` (starts with 48)
...
| Aspect | Hollow Knight | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
