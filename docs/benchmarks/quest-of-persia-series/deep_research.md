# Quest of Persia series - Deep Research Analysis

**Priority:** 64 (TIER_3)
**Research Status:** ⏳ TODO - Copy prompt from `docs/benchmarks/prompts/64_*.md` and paste into Claude Deep Research
...
1. **Get the prompt**
   ...
   - Find file: `64_*_research_prompt.md` (starts with 64)
...
| Aspect | Quest of Persia series | Game A | Game B |
|--------|-----------|--------|--------|
| Combat Feel | | | |
| Scope | | | |
| Team Size | | | |
